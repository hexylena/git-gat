...
git checkout $(git log main --pretty=oneline | grep "admin/job-destinations/0001" | cut -c1-40)
## Run test case
./.scripts/19-job-destinations-test/1.sh

# CMD
## Checkout
git checkout $(git log main --pretty=oneline | grep "admin/job-destinations/0006" | cut -c1-40)
## Run command
if [[ -z ${GALAXY_VERSION} ]]; then
ansible-playbook galaxy.yml -i ~/.hosts --vault-password-file ~/.vault-password.txt
else
...
# CMD
## Checkout
git checkout $(git log main --pretty=oneline | grep "admin/job-destinations/0009" | cut -c1-40)
## Run command
if [[ -z ${GALAXY_VERSION} ]]; then
ansible-playbook galaxy.yml -i ~/.hosts --vault-password-file ~/.vault-password.txt
else
...
git checkout $(git log main --pretty=oneline | grep "admin/job-destinations/0009" | cut -c1-40)
## Run test case
./.scripts/19-job-destinations-test/2.sh

# CMD
## Checkout
git checkout $(git log main --pretty=oneline | grep "admin/job-destinations/0012" | cut -c1-40)
## Run command
if [[ -z ${GALAXY_VERSION} ]]; then
ansible-playbook galaxy.yml -i ~/.hosts --vault-password-file ~/.vault-password.txt
else
...
# CMD
## Checkout
git checkout $(git log main --pretty=oneline | grep "admin/job-destinations/0015" | cut -c1-40)
## Run command
if [[ -z ${GALAXY_VERSION} ]]; then
ansible-playbook galaxy.yml -i ~/.hosts --vault-password-file ~/.vault-password.txt
else
...
# CMD
## Checkout
git checkout $(git log main --pretty=oneline | grep "admin/job-destinations/0017" | cut -c1-40)
## Run command
if [[ -z ${GALAXY_VERSION} ]]; then
ansible-playbook galaxy.yml -i ~/.hosts --vault-password-file ~/.vault-password.txt
else
...
git checkout $(git log main --pretty=oneline | grep "admin/job-destinations/0017" | cut -c1-40)
## Run test case
./.scripts/19-job-destinations-test/3.sh

# CMD
## Checkout
git checkout $(git log main --pretty=oneline | grep "admin/job-destinations/0022" | cut -c1-40)
## Run command
if [[ -z ${GALAXY_VERSION} ]]; then
ansible-playbook galaxy.yml -i ~/.hosts --vault-password-file ~/.vault-password.txt
else
