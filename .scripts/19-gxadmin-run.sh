...
# CMD
## Checkout
git checkout $(git log main --pretty=oneline | grep "admin/gxadmin/0000" | cut -c1-40)
## Run command
ansible-galaxy install -p roles -r requirements.yml

# CMD
## Checkout
git checkout $(git log main --pretty=oneline | grep "admin/gxadmin/0002" | cut -c1-40)
## Run command
