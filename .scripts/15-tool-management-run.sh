...
# CMD
## Run command
shed-tools install -g https://galaxy.example.org -a adminkey --name bwa --owner devteam --section_label Mapping

# CMD
## Run command
shed-tools install -g https://galaxy.example.org -a adminkey -t workflow_tools.yml

# CMD
## Run command
shed-tools test -g https://galaxy.example.org -a adminkey --name bamtools_filter --owner devteam
