...
# CMD
## Checkout
git checkout $(git log main --pretty=oneline | grep "admin/ansible-galaxy/0007" | cut -c1-40)
## Run command
...
# CMD
## Checkout
git checkout $(git log main --pretty=oneline | grep "admin/ansible-galaxy/0012" | cut -c1-40)
## Run command
...
# CMD
## Checkout
git checkout $(git log main --pretty=oneline | grep "admin/ansible-galaxy/0024" | cut -c1-40)
## Run command
if [[ -z ${GALAXY_VERSION} ]]; then
ansible-playbook galaxy.yml -i ~/.hosts --vault-password-file ~/.vault-password.txt
else
...
# CMD
## Checkout
git checkout $(git log main --pretty=oneline | grep "admin/ansible-galaxy/0031" | cut -c1-40)
## Run command
